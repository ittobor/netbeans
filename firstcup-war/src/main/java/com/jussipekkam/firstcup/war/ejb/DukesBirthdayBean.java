 ...
 */
package com.jussipekkam.firstcup.war.ejb;

import com.jussipekkam.firstcup.war.entity.FirstcupUser;
...
public class DukesBirthdayBean {
    ...
    private static final Logger logger
            = Logger.getLogger("com.jussipekkam.firstcup.war.ejb.DukesBirthdayBean");
