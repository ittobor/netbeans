 ...
 */
package com.jussipekkam.firstcup.war.web;

import com.jussipekkam.firstcup.war.ejb.DukesBirthdayBean;
...
public class DukesBDay implements Serializable {
    ...
    private static final Logger logger = Logger.getLogger("com.jussipekkam.firstcup.war.web.DukesBDay");
